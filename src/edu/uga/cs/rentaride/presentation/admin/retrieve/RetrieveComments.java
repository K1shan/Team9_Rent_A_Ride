...
public class RetrieveComments extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			List<Comment> comments = logicLayer.findComments(-1);
			// Making json objects
			Gson gson = new Gson();
			JsonElement element = gson.toJsonTree(comments, new TypeToken<List<Comment>>() {}.getType());
